...
(function() {
  var Highlight, Journo, catchErrors, compareManifest, fatal, folderContents, fs, htmlPath, knox, loadConfig, loadManifest, manifestPath, marked, ncp, path, postName, postPath, postTitle, postUrl, s3, shared, writeManifest, _,
  ...
  Journo.feed = function() {
    var RSS, config, content, description, feed, lexed, post, sorted, title, _i, _len, _ref, _ref1;
    RSS = require('rss');
    loadConfig();
